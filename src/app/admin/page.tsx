...
export default function AdminPage() {
  ...
  if (!session) {
    return (
      <>
        <Head>
          <title>Admin Login | Cynthia's Photography</title>
          <meta name="description" content="Admin login for photography business management." />
  ...
  return (
    <>
      <Head>
        <title>Admin Dashboard | Cynthia's Photography</title>
        <meta name="description" content="Admin dashboard for managing photography business, bookings, and collections." />
        <meta name="robots" content="noindex, nofollow" />
      </Head>
